        ...
        if file_path:
            ...
            if best_match:
                ...
                if is_correct:
                    ...
                    brand = simpledialog.askstring("Brand", "Enter the brand name", parent=root)
                    size = simpledialog.askstring("Size", "Enter shoe size", parent=root)
                    if correct_label:
                        save_inventory_to_db(file_path, correct_label, brand, size)
            else:
